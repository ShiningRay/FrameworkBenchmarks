...
def start(args, logfile, errfile):
  ...
  try:
    subprocess.check_call("rvm jruby-1.7.9 do bundle install --gemfile=Gemfile-jruby", shell=True, cwd="rails", stderr=errfile, stdout=logfile)
    ...
    subprocess.Popen("rvm jruby-1.7.9 do jruby --server --2.0 -S bundle exec torqbox -b 0.0.0.0 -E production", shell=True, cwd="rails", stderr=errfile, stdout=logfile)
    return 0
